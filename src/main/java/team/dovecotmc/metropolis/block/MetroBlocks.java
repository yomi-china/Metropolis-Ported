...
//    public static final Block BLOCK_PIDS_1 = register("pids_1", new BlockMetroPIDSOne());
    ...
    // Platform
    public static final Block BLOCK_PLATFORM_A = register("platform_a", new BlockMetroPlatform(BlockBehaviour.Properties.of(Material.STONE, DyeColor.LIGHT_GRAY).strength(6.0f), BlockMetroPlatform.PlatformShape.NORMAL));
    public static final Block BLOCK_PLATFORM_A_SLIM = register("platform_a_slim", new BlockMetroPlatform(BlockBehaviour.Properties.of(Material.STONE, DyeColor.LIGHT_GRAY).strength(6.0f), BlockMetroPlatform.PlatformShape.SLIM));
    ...
    public static final Block BLOCK_AWNING_PILLAR_EMERGENCY = register("awning_pillar_emergency", new BlockAwningPillarEmergency(BlockBehaviour.Properties.of(Material.STONE, DyeColor.LIGHT_GRAY).strength(6.0f)));
    public static final Block BLOCK_AWNING_BEAM = register("awning_beam", new BlockAwningBeam(BlockBehaviour.Properties.of(Material.STONE, DyeColor.LIGHT_GRAY).strength(6.0f)));
    ...
    // Blind path
    public static final Block BLOCK_BLIND_PATH = register("blind_path", new BlockBlindPath(BlockBehaviour.Properties.of(Material.STONE, DyeColor.YELLOW).strength(4.0f)));
